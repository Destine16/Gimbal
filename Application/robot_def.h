...
#define GIMBAL_SYSID_YAW_PERF_STEP 5u
#define GIMBAL_SYSID_PITCH_PERF_STEP 6u
#define GIMBAL_SYSID_YAW_PERF_SINE 7u
#define GIMBAL_SYSID_PITCH_PERF_SINE 8u
#define GIMBAL_SYSID_PITCH_PRBS 9u
#define GIMBAL_SYSID_YAW_FAST_MULTISINE 10u
#define GIMBAL_SYSID_PITCH_FAST_MULTISINE 11u
#define GIMBAL_SYSID_PITCH_FF_SWEEP 12u
#define GIMBAL_SYSID_PITCH_STATIC_FF_MAP 13u
...
#error "GIMBAL_SYSID_MODE must be 0..13"
#endif
