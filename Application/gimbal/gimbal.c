...
void GimbalInit(void)
{
    ...
    yaw_motor = GM6020_Init(&(GM6020_Init_Config_s){
        ...
        .output_ff_speed_raw = GimbalYawParam.output_ff_speed_raw,
        .output_ff_speed_max_raw = GimbalYawParam.output_ff_speed_max_raw,
        .output_ff_hyst_raw = GimbalYawParam.output_ff_hyst_raw,
        .output_ff_hyst_transition_rad_s = GimbalYawParam.output_ff_hyst_transition_rad_s,
    ...
    pitch_motor = GM6020_Init(&(GM6020_Init_Config_s){
        ...
        .output_ff_speed_raw = GimbalPitchParam.output_ff_speed_raw,
        .output_ff_speed_max_raw = GimbalPitchParam.output_ff_speed_max_raw,
        .output_ff_hyst_raw = GimbalPitchParam.output_ff_hyst_raw,
        .output_ff_hyst_transition_rad_s = GimbalPitchParam.output_ff_hyst_transition_rad_s,
