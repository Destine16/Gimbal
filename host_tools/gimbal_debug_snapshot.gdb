...
define gimbal_snapshot
    ...
    printf "\n[vision rx]\n"
    printf "packets=%u bytes=%u valid=%u crc_err=%u latest_valid=%u latest_pending=%u\n", vision_debug.usb_rx_packet_count, vision_debug.usb_rx_byte_count, vision_debug.valid_frame_count, vision_debug.crc_error_count, vision_debug.latest_cmd_valid, vision_debug.latest_cmd_pending
    ...
    x/8xb &vision_debug.last_usb_packet_bytes[0]
    printf "last_valid_frame: "
    x/8xb &vision_debug.last_valid_frame[0]
